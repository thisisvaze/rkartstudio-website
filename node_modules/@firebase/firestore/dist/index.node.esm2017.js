 ...
 */
class MultiTabIndexedDbComponentProvider extends IndexedDbComponentProvider {
    async initialize(cfg) {
...
class Firestore {
    ...
    async clearPersistence() {
        ...
        this._queue.enqueueAndForgetEvenAfterShutdown(async () => {
            try {
                await this._componentProvider.clearPersistence(this._databaseId, this._persistenceKey);
                deferred.resolve();
            }
            catch (e) {
                deferred.reject(e);
...
function registerFirestore(instance) {
    configureForFirebase(instance, (app, auth) => new Firestore(app, auth, new MultiTabIndexedDbComponentProvider()));
