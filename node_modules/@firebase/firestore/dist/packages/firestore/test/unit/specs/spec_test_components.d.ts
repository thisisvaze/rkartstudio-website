 ...
 */
import { ComponentConfiguration, MemoryComponentProvider, MultiTabIndexedDbComponentProvider } from '../../../src/core/component_provider';
...
export declare class MockIndexedDbComponentProvider extends MultiTabIndexedDbComponentProvider {
    private readonly window;
    private readonly document;
    persistence: MockIndexedDbPersistence;
    constructor(window: WindowLike, document: FakeDocument);
