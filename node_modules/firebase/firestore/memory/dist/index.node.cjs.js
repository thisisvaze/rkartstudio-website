...
function(t, e, n, r, i) {
    ...
    return Object.defineProperty(t.prototype, "i", {
        ...
        return k$1(this.projectId, t.projectId) || k$1(this.database, t.database);
    }, t;
}();
 ...
 */ var C$1 = /** @class */ function() {
    ...
    return t.now = function() {
        ...
        return this.seconds === t.seconds ? k$1(this.nanoseconds, t.nanoseconds) : k$1(this.seconds, t.seconds);
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.$e = function(t) {
        ...
        return this.Ie = pt(), this.Ae = St(), this.Re = new ct(k$1), i;
    }, 
    /**
    ...
    t.prototype.de = function(t) {
        ...
        var e = this.Ae.get(t);
        return e || (e = new ct(k$1), this.Ae = this.Ae.nt(t, e)), e;
    }, 
    /**
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function qt(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return U$1(t.arrayValue.values || [], e.arrayValue.values || [], qt);
...
function jt(t, e) {
    var n = Ct(t), r = Ct(e);
    if (n !== r) return k$1(n, r);
    switch (n) {
      case 0 /* NullValue */ :
        return 0;

      case 1 /* BooleanValue */ :
        return k$1(t.booleanValue, e.booleanValue);
      ...
      case 5 /* StringValue */ :
        return k$1(t.stringValue, e.stringValue);
      ...
      case 7 /* RefValue */ :
        return function(t, e) {
            ...
            return k$1(n.length, r.length);
        }(t.referenceValue, e.referenceValue);

      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = k$1(zt(t.latitude), zt(e.latitude));
            return 0 !== n ? n : k$1(zt(t.longitude), zt(e.longitude));
...
function Ft(t, e) {
    if ("string" == typeof t && "string" == typeof e && t.length === e.length) return k$1(t, e);
    var n = Bt(t), r = Bt(e), i = k$1(n.seconds, r.seconds);
    return 0 !== i ? i : k$1(n.nanos, r.nanos);
}
...
function Ge(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.Ue.isEqual(e.Ue) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.Me.isEqual(e.Me) : 2 /* Transform */ !== t.type || U$1(t.fieldTransforms, t.fieldTransforms, (function(t, e) {
        return function(t, e) {
            return t.field.isEqual(e.field) && function(t, e) {
                return t instanceof _e && e instanceof _e || t instanceof Pe && e instanceof Pe ? U$1(t.elements, e.elements, qt) : t instanceof ke && e instanceof ke ? qt(t.qe, e.qe) : t instanceof Te && e instanceof Te;
...
var zn = /** @class */ function() {
    ...
    return t.br = function(t, e) {
        return W$1.P(t.key, e.key) || k$1(t.Lr, e.Lr);
    }, 
    /** Compare by ID then by key */ t.Cr = function(t, e) {
        return k$1(t.Lr, e.Lr) || W$1.P(t.key, e.key);
    }, t;
}();
...
var br = /** @class */ function(e) {
     ...
     */
    t.prototype.T = function(t) {
        return k$1(this.Yr, t.Yr) || k$1(this.Xr, t.Xr);
    }, t;
}();
...
n) {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    /* targetMismatches= */ new ct(k$1), o, s), [ 4 /*yield*/ , this.Ji(u) ]) : [ 3 /*break*/ , 2 ];
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.vu = function(t) {
        ...
        n || (n = new ut(k$1)), n = n.nt(t, e), this._u[this.currentUser.lo()] = n;
    }, 
    /**
    ...
    return t.prototype.Ju = function(t) {
        ...
        // because it precedes all other segments in an ordered traversal.
                W$1.W(i) || (i = i.child(""));
        var o = new Qn(new W$1(i), 0), s = new ct(k$1);
...
var Ei = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        ...
        if (t.ml.El) throw new x$1(q$1.FAILED_PRECONDITION, Ui);
        return new Ii(Ai.qc);
        ...
        throw new x$1(q$1.FAILED_PRECONDITION, Ui);
    }, t;
}(), Li = /** @class */ function() {
    function t(t, 
    /**
